...
public class HttpClient {
    ...
    protected void callHttps() throws IOException, CertificateException, KeyStoreException, NoSuchAlgorithmException,
        ...
        if (!jksCAFile.isFile()) {
            ...
            // store jks file
            HttpClientUtil.storeCACert(cert, HttpClient.JKS_CA_ALIAS, HttpClient.JKS_CA_PASSWORD, out);
        ...
        SSLContext sslContext = HttpClientUtil.getSSLContext(trustStream, HttpClient.JKS_CA_PASSWORD, keyStream,
                this.certPasswd);
